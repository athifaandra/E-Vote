...
<html>
  <head>
    ...
    <style>
      ...
      body.skin-green {
      --teal-300: #00796b; /* Ganti dengan nilai warna yang diinginkan */
      }
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>E</b>-VP</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>E</b>-Voting Pegawai</span>
        </a>

        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top">
        <img src="https://padangkota.bps.go.id/backend/images/Header-Frontend-Besar-ind.png" class="img" style="max-width: 100%; height: auto;">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidat') { echo 'class="active"'; } ?>>
                <a href="?page=kandidat"><i class="fa fa-file-text-o"></i> <span>Manajemen Jenis Voting</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidat') { echo 'class="active"'; } ?>>
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kelas') { echo 'class="active"'; } ?>>
                <a href="?page=kelas"><i class="fa fa-university"></i> <span>Manajemen Periode</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'perolehan') { echo 'class="active"'; } ?>>
                <a href="?page=perolehan"><i class="fa fa-bar-chart"></i> <span>Voting Tahap 1</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'perolehan') { echo 'class="active"'; } ?>>
                <a href="?page=perolehan"><i class="fa fa-bar-chart"></i> <span>Voting Tahap 2</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'perolehan') { echo 'class="active"'; } ?>>
