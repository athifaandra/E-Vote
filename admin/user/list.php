      ...
      <table class="table table-striped table-hover">
            ...
            <tbody>
                  ...
                  while($data = mysqli_fetch_array($sql)) {
                        ...
                        <td style="text-align:center;vertical-align:middle;">
                              <a href="?page=user&action=edit&id=<?php echo $data['nip_bpspegawai']; ?>" class="btn btn-warning btn-sm">
                              Edit
                              </a>
                              <a href="?page=user&action=hapus&id=<?php echo $data['nip_bpspegawai']; ?>" onclick="return confirm('Yakin ingin menghapus user ini ?');" class="btn btn-danger btn-sm">
                              Hapus
                              </a>
                        </td>
                        </tr>
